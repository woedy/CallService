...
def place_single_call_task(call_id):
    ...
    payload = {
        ...
        "variables": {
            ...
            "AUDIO_GREETING": dynamic_greeting_sound or _asterisk_sound(greeting_file, DEFAULT_CUSTOM_AUDIO["greeting"]),
